...
export default function Collaboration() {
  ...
  return (
    <section ref={ref} id="collaboration" className="opacity-0">
      <div className="text-white px-5 md:px-7 py-32 lg:py-18 relative flex flex-col gap-8 md:flex-row justify-center md:justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="flex flex-col gap-3 items-center font-semibold text-sm text-white">
              <a href="#footer" className="group rounded-lg p-[2px] bg-gradient-to-r from-cyan-400 to-blue-600">
                <div className="bg-[#0f0f0f] rounded-[6px] px-12 py-3 transition-all duration-300 group-hover:bg-transparent">
                  <span className="text-white font-semibold">Hubungi Saya</span>
                </div>
              </a>
