export default function ContentComponent() {
  return (
    <div className="text-light mx-5 lg:mx-12">
        <h2 className="font-semibold tracking-wide sm:text-lg lg:text-2xl md:text-center">Tentang Saya</h2>
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-12 mt-3 lg:mt-8">
            <h3 className="font-bold tracking-wider font-rock-salt text-2xl lg:text-[28px] 2xl:text-[32px] leading-relaxed lg:w-[40%] relative line-bottom-about text-center lg:text-start lowercase">kisah singkat & awal mula perjalananku</h3>
