  ...
  return (
    <div className="flex flex-col gap-1">
        ...
        <div className="flex gap-6 justify-start mt-1 lg:mt-2">
            <a href={proyek} className="text-sm sm:text-base font-medium flex items-center gap-1.5">
                <span>Lihat Proyek</span>
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-2.5 h-2.5 sm:w-3 sm:h-3">
                <path d="M2 12L12 2M12 2H3M12 2V11" stroke="#181C14" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            </a>
            <a href={studiKasus} className="text-sm sm:text-base font-medium flex items-center gap-1">
                <span>Studi Kasus</span>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-4.5 sm:h-4.5">
