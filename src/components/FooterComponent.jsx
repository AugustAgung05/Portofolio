            ...
            <div className="mx-5 pt-8 pb-4">
                <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-start">
                    <div className="lg:w-[250px] xl:w-[300px]">
                        ...
                        <div className="mt-4 lg:mt-6 justify-center flex gap-5 lg:gap-7">
                    ...
                    <div className="mt-6 lg:mt-0">
                        ...
                        <ul className="mt-2 lg:mt-3 space-y-1 lg:space-y-2.5 text-sm lg:text-xs xl:text-sm">
                    ...
                    <div className="mt-6 lg:mt-0 lg:w-[300px]">
                        ...
                        <div className="mt-4 flex flex-col gap-3">
                            <input className="py-3 px-4 border rounded-lg border-secondary placeholder:text-secondary placeholder:text-sm lg:placeholder:text-xs xl:placeholder:text-sm text-sm lg:text-xs xl:text-sm font-semibold focus:outline-none focus:ring-0 focus:ring-offset-0" type="text" name="email" id="email" placeholder="Email kamu di sini..." />
                            <button className="flex justify-center rounded-lg gap-2 p-3 bg-neon" type="submit">
