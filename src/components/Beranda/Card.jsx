...
export default function Card({ className, title, description, descriptionClass }) {
  return (
    <div className={`bg-bg p-[6px] sm:p-2 not-only-of-type:xs:p-2 rounded-lg animate-float-card ${className}`}>
      <h1 className={`text-light font-light text-[10px] xs:text-[11px] s:text-[12px] sm:text-[13px] lg:text-[11px] xl:text-sm tracking-wide`}>{title}</h1>
