...
export default function Portofolio() {
    ...
    return (
        <section ref={ref} id="portofolio" className="py-16 opacity-0">
            <div className='mx-5 lg:mx-12 text-white'>
                ...
                <div className="flex flex-col md:flex-row md:flex-wrap gap-3 md:gap-8 mt-10 lg:mt-12 justify-center items-center">
                    ...
                    <Card category="Client" title="Inventory" description="Web Application Design" logo={InventoryLogo} contentImg={[Inventory, InventoryDesign, Inventory1, Inventory2, Inventory3, Inventory4, Inventory5, InventoryUML]} role="UI/UX Designer & Database Designer" contentDesc="Mendesain solusi digital end-to-end untuk manajemen inventaris pabrik. Selain merancang antarmuka visual yang efisien, saya juga membangun struktur relasi database (ERD) yang kompleks untuk memastikan validitas data arus barang, mulai dari penerimaan supplier hingga distribusi logistik." scopes={["Web App Design", "ERD & Database Modeling", "Complex Logic Mapping"]} tools={["Figma", "UML Tools"]} features={["Manajemen Supplier & Stok", "Dashboard Logistik", "Penjadwalan Pengiriman", "Perancangan Relasi Database (ERD)"]} link="figma.com/proto/A4Wnk74eayxNSHpB3gaEWq/Projek-Inventory--Client-?node-id=0-1&p=f&t=muLFh4TJm4WKQcwq-0&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=75%3A2178" />
                    ...
                    <Card category="Client" title="Diagram" description="UML Diagram Design" logo={DiagramLogo} contentImg={[]} role="" contentDesc="" scopes={[]} tools={[]} features={[]} link=""/>
