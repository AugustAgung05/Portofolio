    ...
    return (
        <>
            <section className="relative w-fit rounded-xl group cursor-pointer">
                ...
                <div className="relative z-10 w-[250px] md:w-[350px] h-[140px] md:h-[200px] bg-[#0F1722] flex items-center rounded-lg transition-opacity duration-300 group-hover:opacity-20" onClick={() => setOpen(true)}>
