                    ...
                    <div className="md:col-span-5 order-2 md:order-1">
                        <div className="bg-gray-900/80 p-6 rounded-xl border border-gray-800">
                            ...
                            <ul className="flex gap-3 list-none mt-4 items-center">
                                <li className="p-1.5 rounded-full bg-[linear-gradient(to_right,#22d3ee,#3b82f6)] bg-[length:0%_100%] bg-left bg-no-repeat transition-all duration-300 hover:bg-[length:100%_100%] text-neon hover:text-bg">
                                    <a href="https://www.github.com/augustagung05">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-8 lg:w-10 fill-current">
                                ...
                                <li className="p-1.5 rounded-full bg-[linear-gradient(to_right,#22d3ee,#3b82f6)] bg-[length:0%_100%] bg-left bg-no-repeat transition-all duration-300 hover:bg-[length:100%_100%] text-neon hover:text-bg">
                                    <a href="https://www.instagram.com/anandast.05/">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-8 lg:w-10 fill-current">
                                ...
                                <li className="p-1.5 rounded-full bg-[linear-gradient(to_right,#22d3ee,#3b82f6)] bg-[length:0%_100%] bg-left bg-no-repeat transition-all duration-300 hover:bg-[length:100%_100%] text-neon fill-current hover:text-bg">
                                    <a href="https://wa.me/6285778208790">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-8 lg:w-10 fill-current">
