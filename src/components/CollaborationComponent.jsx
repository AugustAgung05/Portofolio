export default function CollaborationComponent() {
  return (
    <div className="flex flex-col gap-8 sm:flex-row text-white mx-5 lg:mx-32 my-8 sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-3 items-center font-medium text-sm">
            ...
            <button className="bg-white text-bg px-13 py-3 rounded-lg">Lihat Portofolio</button>
        </div>
    </div>
  );
}