export default function CollaborationComponent() {
  return (
    <div className="flex flex-col gap-8 sm:flex-row text-light mx-5 lg:mx-12 my-8 sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-3 items-center font-medium text-sm">
            <button className="bg-primary text-secondary rounded-lg border border-secondary px-13 py-3">Hubungi Saya</button>
