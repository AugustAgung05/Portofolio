            ...
            <section className="mt-12 lg:mt-26 xl:mt-44 flex flex-col mx-5 lg:mx-8">
                <div className="flex flex-col lg:gap-[38%] xl:gap-[42%] 2xl:gap-[37%] lg:min-h-[320px] justify-center lg:flex-row lg:items-center lg:relative">
                    ...
                    <div className="lg:min-w-[340px] mt-12 lg:mt-0 lg:self-end">
                        ...
                        <h1 className="text-light font-mono font-bold text-center lg:text-start mt-3 lg:mt-6 lg:ml-3 xl:ml-5 2xl:ml-0 tracking-wider text-[24px] md:text-[26px] lg:text-[24px] 2xl:text-[28px] 3xl:text-[32px] tracking-in-expand line-bottom-home relative font-rock-salt">ananda agung styadi</h1>
                    ...
                    <div className="mt-12 lg:mt-0 lg:max-w-[280px] xl:max-w-[330px] 2xl:max-w-[350px] lg:self-start">
                        ...
                        <div className="flex mt-4">
                            <a href="" className="flex gap-3 group xl:gap-5 3xl:gap-7">
                                <span className="text-neon text-sm font-medium md:text-base lg:text-[13px] xl:text-base 3xl:text-lg">lihat selengkapnya</span>
